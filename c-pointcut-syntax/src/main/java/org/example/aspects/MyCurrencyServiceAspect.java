...
public class MyCurrencyServiceAspect {
   ...
   // @AfterReturning(value = "withinPointCut()",returning = "value")
    public void afterReturningAdvice(JoinPoint joinPoint,String value){
        System.out.println("AfterReturningAdvice %s method return type is %s."
    ...
    public Object aroundAdvice(ProceedingJoinPoint joinPoint)throws Throwable{
        System.out.println("Before %s method invoked."
                .formatted(joinPoint.getSignature().getName()));
        try{
            ...
            System.out.println(
                    "%s method throws %s exception.".formatted(
                            joinPoint.getSignature().getName(),
                            e.getClass().getSimpleName()
                    )
            );
        }finally {
            System.out.println("After %s method invoked.".formatted(joinPoint
   ...
   // @After("annotationTargetPointCut()")
